class Fully_Conection_Model(nn.Module):
  def __init__(self):
    ...
    self.Linear_2 = nn.Linear(4096, 512, bias = True)
    self.Linear_3 = nn.Linear(512, 512, bias = True)
    self.Linear_4 = nn.Linear(512, 4096, bias = True)
    ...
    nn.init.normal_(self.Linear_Cls.weight, std = 0.001)
  ...
  def forward(self, Model_INPUT):
    ...
    Classification_Output = self.Linear_Cls(FC_11)
    Bbox_Regression_Output = self.Linear_Reg(FC_11)
